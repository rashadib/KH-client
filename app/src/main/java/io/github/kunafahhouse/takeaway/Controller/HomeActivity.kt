...
import io.github.kunafahhouse.takeaway.Adapter.MenuViewHolder
import io.github.kunafahhouse.takeaway.Interface.ItemClickListener
import io.github.kunafahhouse.takeaway.Model.Category
import io.github.kunafahhouse.takeaway.R
import io.github.kunafahhouse.takeaway.Utils.CATEGORY_EXTRA
    ...
    private fun loadMenuItems() {
        ...
        viewHolder = object : FirebaseRecyclerAdapter<Category, MenuViewHolder>(categoryOption) {
            ...
            override fun onBindViewHolder(holder: MenuViewHolder, position: Int, model: Category) {
                ...
                holder.categoryName.text = "KUNAFAH"
                Picasso.get()
                        .load(model.image)
